...
sequelize.define('quiz', {      //Defino el quiz, que es un modelo de datos
    question: {
        ...
        unique: {msg: "No existe esta pregunta"}, //Cada pregunta es única, si se repite me sale este mensaje
...
sequelize.sync()
    .then(() => sequelize.models.quiz.count())  //Cuenta cuántos quizzes hay y lo pasaremos luego como parámetro en el then
.then(count => {
    if (!count) { //Si hay cero quizzes necesito crear más, por tanto
